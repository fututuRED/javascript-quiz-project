document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    const progressPercentage = ((quiz.currentQuestionIndex / quiz.questions.length) * 100).toFixed(0);
    ...
    // Loop through the current question `choices`.
      ...
      */
      ...
      question.choices.forEach(choice => {
        ...
        // Append the radio input and the label to the choice container
...
showQuestion()
  ...
  function showResults() {
    ...
    // 3. Update the result container (div#result) inner text to show the number of correct answers out of total questions
     `You scored 1 out of 1 correct answers!`; // This value is hardcoded as a placeholder
  }
